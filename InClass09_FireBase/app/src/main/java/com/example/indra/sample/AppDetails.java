 ...
 */public class AppDetails implements Serializable{
    String id,App_Title,Developer_name,uri,small_photo_url,large_photo_url,app_price,release_date,category;
    boolean fav=false;
    ...
    public AppDetails returnAppdetails(String s){
        if (s.equals(this.App_Title)) {
            return this;
        }
        return null;
    }
