...
public  class  MainActivity extends AppCompatActivity implements GetXml.IData {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View child = getLayoutInflater().inflate(R.layout.liner_view, null);
       linearLayout.addView(child);

       /*
        LinearLayout linearLayout1 = (LinearLayout) findViewById(R.id.linear_view);
...
*/
    ...
    void display(final ArrayList<AppDetails> result){
        ...
        mAdapter = new MyAdapter(this,result,layout,mRecyclerView,new MyAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View v, final AppDetails item) {
    ...
    public  void audioplay(AppDetails appDetails){
