...
public class AppDetailsUtill {
    public static class ParseAppDetails extends DefaultHandler {
        ...
        public static AppDetails[] ParseXml(InputStream in) throws IOException, SAXException {
        ...
        public AppDetails[] getAppDetailsList() {
        ...
        public void startDocument() throws SAXException {
            ...
            appDetailsList = new AppDetails[100];
        }
