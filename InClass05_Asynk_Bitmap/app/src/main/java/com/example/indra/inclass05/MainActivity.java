package com.example.indra.inclass05;
   ...
   String[] images = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(check ==0) {
            ...
            findViewById(R.id.imageViewNext).setVisibility(View.GONE);
            findViewById(R.id.imageViewPrevious).setVisibility(View.GONE);
    ...
    public class DoWork extends AsyncTask<String,Void,String> {
        ...
        protected void onPostExecute(String s) {
            ...
            findViewById(R.id.imageViewNext).setVisibility(View.VISIBLE);
            findViewById(R.id.imageViewPrevious).setVisibility(View.VISIBLE);
